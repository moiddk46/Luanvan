<nav class="navbar navbar-dropdown navbar-expand-lg mx-5 mt-3 px-4 fixed-top navCustom ">
    <div class="container px-5 contentnav fs-5">
        ...
        <div class="collapse navbar-collapse opacityScroll" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-dropdown nav-right" data-app-modern-menu="true">
                <li class="nav-item">
                    <a class="nav-link link text-black display-4" href="">Trang Chủ</a>
                </li>
                    ...
                    <ul class="dropdown-menu bg-light">
                        @if (isset($prop))
                            @foreach ($prop as $item)
                                <li><a class="dropdown-item link" href="#">{{ $item->service_name }}</a></li>
                            @endforeach
                        @endif
                    </ul>
                </li>
