...
@section('content')
    <div class="border border-light px-5">
        ...
        <div class="row py-5">
                ...
                <div class="card l-bg-blue-dark">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div class="row align-items-center mb-2 d-flex">
                            ...
                            <div class="col-4 text-right">
                                <span>9.23% <i class="bi bi-arrow-up"></i></span>
                            </div>
                        </div>
                        <div class="progress mt-1 " data-height="8" style="height: 8px;">
                ...
                <div class="card l-bg-green-dark">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div class="row align-items-center mb-2 d-flex">
                            ...
                            <div class="col-4 text-right">
                                <span>10% <i class="bi bi-arrow-up"></i></span>
                            </div>
                        </div>
                        <div class="progress mt-1 " data-height="8" style="height: 8px;">
                ...
                <div class="card l-bg-orange-dark">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div class="row align-items-center mb-2 d-flex">
                            ...
                            <div class="col-4 text-right">
                                <span>2.5% <i class="bi bi-arrow-up"></i></span>
                            </div>
                        </div>
                        <div class="progress mt-1 " data-height="8" style="height: 8px;">
                            <div class="progress-bar l-bg-cyan" role="progressbar" data-width="25%" aria-valuenow="25"
            ...
            <canvas id="myChart" class="w-75 h-75 m-auto mt-5"></canvas>
        </div>
    </div>
@endsection
